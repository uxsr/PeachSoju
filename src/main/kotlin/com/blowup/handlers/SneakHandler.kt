...
object SneakHandler {
    ...
    fun setSneak(sneak: Boolean, onConfirm: (() -> Unit)? = null) {
        ...
        com.blowup.utils.RouteUtils.debug("§d[Sneak] setSneak($sneak), callback=${onConfirm != null}")
        ...
        if (onConfirm != null) {
            ...
            com.blowup.utils.RouteUtils.debug("§d[Sneak] Waiting $requiredTicks ticks for confirm")
        } else {
