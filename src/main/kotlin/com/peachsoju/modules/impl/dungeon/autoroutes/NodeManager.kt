...
import com.peachsoju.utils.handlers.drawAnimatedDashedLine
import com.peachsoju.utils.handlers.drawCornerBox
import com.peachsoju.utils.handlers.drawDashedWireBox
import com.peachsoju.utils.handlers.drawDiamond
import com.peachsoju.utils.handlers.drawFilledBox
import com.peachsoju.utils.handlers.drawPulseBox
import com.peachsoju.utils.handlers.drawPulseInfillInvertedPyramid
import com.peachsoju.utils.handlers.drawWireFrameBox
import com.peachsoju.utils.handlers.drawXBox
...
object  NodeManager {
    ...
    fun addFromCommand(rawArgs: String): String {
        ...
        val parsed = parseAddArgs(rawArgs) ?: return """
            ...
            §7Types: §fether, aotv, hype, superboom, await, useitem, nop, walk, stop, aligns
    ...
    fun setNodeModifier(index: Int, modifier: String, value: String?): String {
        ...
        val newNode = when (modifier.lowercase()) {
            ...
            "awaitnpc", "npc" -> node.copyWith(awaitNpc = value?.toBooleanStrictOrNull() ?: !node.awaitNpc)
    ...
    private fun parseAddArgs(raw: String): ParsedArgs? {
        ...
        for (i in 1 until parts.size) {
            ...
            when {
                ...
                part == "npc" || part == "awaitnpc" -> modifiers["awaitnpc"] = "true"
    ...
    private fun makeNode(
        ...
        return WaypointNode(
            ...
            awaitNpc = modifiers.containsKey("awaitnpc"),
    ...
    private fun buildModifierString(node: WaypointNode): String {
        ...
        if (node.awaitNpc) parts.add("npc")
    ...
    private fun save() {
        ...
        waypoints.forEach { (roomName, nodes) ->
            ...
            nodes.forEach { node ->
                ...
                obj.addProperty("awaitNpc", node.awaitNpc)
